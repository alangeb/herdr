...
| Tau | lifecycle wrapper when installed; otherwise screen manifest | state and session (experimental) |
| TauRLM | lifecycle wrapper when installed; otherwise screen manifest | state and session (experimental) |
